...
query.obtenertodasHabilidades = function () {
  return `SELECT * FROM habilidades ; `;
};
query.obtenertodasHerramientas = function () {
  return `SELECT * FROM herramientas ; `;
};
query.obtenertodasUsuarios = function () {
  return `SELECT * FROM usuarios ; `;
};
query.obtenertodasPalabrasClave = function () {
  return `SELECT * FROM palabrasclave ; `;
};
query.obtenertodasListaidiomas = function () {
  return `SELECT * FROM listaidiomas ; `;
};
query.obtenertodasContactos = function () {
  return `SELECT * FROM contactos ; `;
};
query.obtenertodasListaContactos = function () {
  return `SELECT * FROM listacontactos ; `;
};
query.obtenertodasListaHabilidades = function () {
  return `SELECT * FROM listahabilidades ; `;
};
query.obtenertodasListaHerramientas = function () {
  return `SELECT * FROM listaherramientas ; `;
};
query.obtenertodasMetodologias = function () {
  return `SELECT * FROM metodologias ; `;
};
query.obtenertodasPracticas = function () {
  return `SELECT * FROM practicas ; `;
};
query.obtenertodasListasPracticas = function () {
  return `SELECT * FROM listapracticas ; `;
};
query.obtenertodasAlfas = function () {
  return `SELECT * FROM alfas ; `;
};
query.obtenertodasListaAlfas = function () {
  return `SELECT * FROM listaalfas ; `;
};
query.obtenertodasHerramientasMetodologia = function () {
  return `SELECT * FROM herramientasmetodologia ; `;
};
query.obtenertodasTecnicas = function () {
  return `SELECT * FROM tecnicas ; `;
};
query.obtenertodasActividades = function () {
  return `SELECT * FROM actividades ; `;
};
query.obtenertodasRoles = function () {
  return `SELECT * FROM roles ; `;
};
query.obtenertodasListaRoles = function () {
  return `SELECT * FROM listaroles ; `;
};
query.obtenertodasIntegrantes = function () {
  return `SELECT * FROM integrantes ; `;
};
query.obtenertodasListaActividades = function () {
  return `SELECT * FROM listaactividades ; `;
};
query.obtenertodasContenidos = function () {
  return `SELECT * FROM contenidos ; `;
};
query.obtenertodasEntregables = function () {
  return `SELECT * FROM entregables ; `;
};
query.obtenertodasListaentregables = function () {
  return `SELECT * FROM listaentregables ; `;
};
query.obtenertodasListaHerramientasMetodologia = function () {
  return `SELECT * FROM listaherramientasmetodologia ; `;
};
query.obtenertodasListaContenidos = function () {
  return `SELECT * FROM listacontenidos ; `;
};
query.obtenertodasEntregas = function () {
  return `SELECT * FROM entregas ; `;
};
query.obtenertodasChats = function () {
  return `SELECT * FROM chats ; `;
};
query.obtenertodasHistoriales = function () {
  return `SELECT * FROM historiales ; `;
};
query.obtenertodasListaChats = function () {
  return `SELECT * FROM listachats ; `;
};
query.obtenertodasProyectos = function () {
  return `SELECT * FROM proyectos ; `;
};
query.obtenertodasReuniones = function () {
  return `SELECT * FROM reuniones ; `;
};
query.obtenertodasListaReuniones = function () {
  return `SELECT * FROM listareuniones ; `;
};
query.obtenertodasListaEntregas = function () {
  return `SELECT * FROM listaentregas ; `;
};
query.obtenertodasEventos = function () {
  return `SELECT * FROM eventos ; `;
};
query.obtenertodasListaEventos = function () {
  return `SELECT * FROM listaeventos ; `;
};
query.obtenertodasListaIntegrantes = function () {
  return `SELECT * FROM listaintegrantes ; `;
};
//-------------busquedas por tablas puntual
query.obtenerunrol = function (id) {
...
query.insertHabilidades = function (
  habilidadtipo,
...
query.insertherramientas = function (
  herramientanombre,
  herramientatipo,
...
query.insertmetodologia = function (
  metodologianombre,
...
query.insertEntregables = function (
  entregatitulo,
  entregadescripcion,
  entregaestado,
  entregatipoArchivo,
...
query.insertActividades = function (
  actividadtitulo,
  actividadestado,
...
query.insertcontenido = function (
  nombre,
  nombrearchivo,
  descripcion,
  bibliografia
...
query.insertherramientametodologia = function (
  nombre,
  descripcion,
  bibliografia
) {
...
query.insertlistherramientametodologia = function (
  entregable,
...
//----------------------------------------------------------------------
query.updateproyecto = function (nombre, descripcion, banner, icono, id) {
  return `UPDATE proyectos 
      SET proyectonombre ="${nombre}",
      proyectodescripcion="${descripcion}",
      proyectoicon="${icono}",
      proyectobanner="${banner}"
      WHERE id = ${id}; `;
};
//----------------------------------------------------------------------
...
query.deleteTabla = function (tabla) {
  return `DELETE FROM ${tabla};`;
};
query.deleteIdiomas = function (id) {
  return `DELETE FROM idiomas WHERE id=${id} ; `;
};
query.deleteHabilidades = function (id) {
  return `DELETE FROM habilidades  WHERE id=${id}; `;
};
query.deleteHerramientas = function (id) {
  return `DELETE FROM herramientas  WHERE id=${id}; `;
};
query.deleteUsuarios = function (id) {
  return `DELETE FROM usuarios  WHERE id=${id}; `;
};
query.deletePalabrasClave = function (id) {
  return `DELETE FROM palabrasclave  WHERE id=${id}; `;
};
query.deleteListaidiomas = function (id) {
  return `DELETE FROM listaidiomas  WHERE usuario=${id}; `;
};
query.deleteContactos = function (id) {
  return `DELETE FROM contactos  WHERE id=${id}; `;
};
query.deleteListaContactos = function (id) {
  return `DELETE FROM listacontactos  WHERE usuario=${id}; `;
};
query.deleteListaHabilidades = function (id) {
  return `DELETE FROM listahabilidades  WHERE usuario=${id}; `;
};
query.deleteListaHerramientas = function (id) {
  return `DELETE FROM listaherramientas  WHERE usuario=${id}; `;
};
query.deleteMetodologias = function (id) {
  return `DELETE FROM metodologias  WHERE id=${id}; `;
};
query.deletePracticas = function (id) {
  return `DELETE FROM practicas  WHERE id=${id}; `;
};
query.deleteListasPracticas = function (id) {
  return `DELETE FROM listapracticas  WHERE practica=${id}; `;
};
query.deleteAlfas = function (id) {
  return `DELETE FROM alfas  WHERE id=${id}; `;
};
query.deleteListaAlfas = function (id) {
  return `DELETE FROM listaalfas  WHERE alfa=${id}; `;
};
query.deleteHerramientasMetodologia = function (id) {
  return `DELETE FROM herramientasmetodologia WHERE id=${id};`;
};
query.deleteTecnicas = function (id) {
  return `DELETE FROM tecnicas  WHERE id=${id}; `;
};
query.deleteActividades = function (id) {
  return `DELETE FROM actividades  WHERE id=${id}; `;
};
query.deleteRoles = function (id) {
  return `DELETE FROM roles  WHERE id=${id}; `;
};
query.deleteListaRoles = function (id) {
  return `DELETE FROM listaroles  WHERE rol=${id}; `;
};
query.deleteIntegrantes = function (id) {
  return `DELETE FROM integrantes  WHERE id=${id}; `;
};
query.deleteListaActividades = function (id) {
  return `DELETE FROM listaactividades  WHERE actividad=${id}; `;
};
query.deleteContenidos = function (id) {
  return `DELETE FROM contenidos  WHERE id=${id}; `;
};
query.deleteEntregables = function (id) {
  return `DELETE FROM entregables  WHERE id=${id}; `;
};
query.deleteListaentregables = function (id) {
  return `DELETE FROM listaentregables  WHERE entregable=${id}; `;
};
query.deleteListaHerramientasMetodologia = function (id) {
  return `DELETE FROM listaherramientasmetodologia  WHERE herramientametodologia=${id}; `;
};
query.deleteListaContenidos = function (id) {
  return `DELETE FROM listacontenidos  WHERE contenido=${id}; `;
};
query.deleteEntregas = function (id) {
  return `DELETE FROM entregas  WHERE id=${id}; `;
};
query.deleteChats = function (id) {
  return `DELETE FROM chats  WHERE id=${id}; `;
};
query.deleteHistoriales = function (id) {
  return `DELETE FROM historiales  WHERE id=${id}; `;
};
query.deleteListaChats = function (id) {
  return `DELETE FROM listachats  WHERE chat=${id}; `;
};
query.deleteProyectos = function (id) {
  return `DELETE FROM proyectos  WHERE id=${id}; `;
};
query.deleteReuniones = function (id) {
  return `DELETE FROM reuniones  WHERE id=${id}; `;
};
query.deleteListaReuniones = function (id) {
  return `DELETE FROM listareuniones  WHERE reunion=${id}; `;
};
query.deleteListaEntregas = function (id) {
  return `DELETE FROM listaentregas  WHERE entregable=${id}; `;
};
query.deleteEventos = function (id) {
  return `DELETE FROM eventos  WHERE id=${id}; `;
};
query.deleteListaEventos = function (id) {
  return `DELETE FROM listaeventos  WHERE evento=${id}; `;
};
query.deleteListaIntegrantes = function (integrante, proyecto) {
  return `DELETE FROM listaintegrantes  WHERE integrante=${integrante} and proyecto=${proyecto}; `;
};

query.deleteallIdiomas = function () {
  return `DELETE FROM idiomas  ; `;
};
query.deleteallHabilidades = function () {
  return `DELETE FROM habilidades ; `;
};
query.deleteallHerramientas = function () {
  return `DELETE FROM herramientas  ; `;
};
query.deleteallUsuarios = function () {
  return `DELETE FROM usuarios  ; `;
};
query.deleteallPalabrasClave = function () {
  return `DELETE FROM palabrasclave ; `;
};
query.deleteallListaidiomas = function () {
  return `DELETE FROM listaidiomas ; `;
};
query.deleteallContactos = function () {
  return `DELETE FROM contactos  ; `;
};
query.deleteallListaContactos = function () {
  return `DELETE FROM listacontactos  ; `;
};
query.deleteallListaHabilidades = function () {
  return `DELETE FROM listahabilidades  ; `;
};
query.deleteallListaHerramientas = function () {
  return `DELETE FROM listaherramientas ; `;
};
query.deleteallMetodologias = function () {
  return `DELETE FROM metodologias  ; `;
};
query.deleteallPracticas = function () {
  return `DELETE FROM practicas  ; `;
};
query.deleteallListasPracticas = function () {
  return `DELETE FROM listapracticas ; `;
};
query.deleteallAlfas = function () {
  return `DELETE FROM alfas  ; `;
};
query.deleteallListaAlfas = function () {
  return `DELETE FROM listaalfas ; `;
};
query.deleteallHerramientasMetodologia = function () {
  return `DELETE FROM herramientasmetodologia ;`;
};
query.deleteallTecnicas = function () {
  return `DELETE FROM tecnicas  ; `;
};
query.deleteallActividades = function () {
  return `DELETE FROM actividades  ; `;
};
query.deleteallRoles = function () {
  return `DELETE FROM roles  ; `;
};
query.deleteallListaRoles = function () {
  return `DELETE FROM listaroles  ; `;
};
query.deleteallIntegrantes = function () {
  return `DELETE FROM integrantes ; `;
};
query.deleteallListaActividades = function () {
  return `DELETE FROM listaactividades  ; `;
};
query.deleteallContenidos = function () {
  return `DELETE FROM contenidos  ; `;
};
query.deleteallEntregables = function () {
  return `DELETE FROM entregables  ; `;
};
query.deleteallListaentregables = function () {
  return `DELETE FROM listaentregables  ; `;
};
query.deleteallListaHerramientasMetodologia = function () {
  return `DELETE FROM listaherramientasmetodologia ; `;
};
query.deleteallListaContenidos = function () {
  return `DELETE FROM listacontenidos ; `;
};
query.deleteallEntregas = function () {
  return `DELETE FROM entregas ; `;
};
query.deleteallChats = function () {
  return `DELETE FROM chats; `;
};
query.deleteallHistoriales = function () {
  return `DELETE FROM historiales  ; `;
};
query.deleteallListaChats = function () {
  return `DELETE FROM listachats ; `;
};
query.deleteallProyectos = function () {
  return `DELETE FROM proyectos  ; `;
};
query.deleteallReuniones = function () {
  return `DELETE FROM reuniones ; `;
};
query.deleteallListaReuniones = function () {
  return `DELETE FROM listareuniones  ; `;
};
query.deleteallListaEntregas = function () {
  return `DELETE FROM listaentregas ; `;
};
query.deleteallEventos = function () {
  return `DELETE FROM eventos ; `;
};
query.deleteallListaEventos = function () {
  return `DELETE FROM listaeventos ; `;
};
query.deleteallListaIntegrantes = function () {
  return `DELETE FROM listaintegrantes  ; `;
};
