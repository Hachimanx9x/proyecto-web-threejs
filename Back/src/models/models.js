      ...
      alfas: [
        {
          ...
          descripcion:
            "define los elementos de valor dentro de la experiencia a ofrecer así mismo ofrece diferentes, métodos para un concepción acertada.",
          estado: "iniciado",
          entregable: ["Propuesta de diseño de la Experiencia Multimedia"],
        },
        {
          nombre: "Diseño responsable",
          descripcion: `Es una sub-alfa que se inscribe en el alfa de Experiencia Multimedia de la adaptación producida al kernel de Esencia, concebida para hacer un seguimiento granular al progreso del diseño responsable que debe concebirse para el Sistema Multimedia, y que influye en consecuencia, en la experiencia multimedia.
                    Su función es producir la especificación de aspectos relacionados con el diseño responsable del Sistema Multimedia.`,
          estado: "iniciado",
          entregable: ["Especificaciones del diseño responsable"],
        },
      ],
      Entregables: [
        {
...
-El Journey Map que ofrece una representación visual de los diferentes elementos descritos.`,
        ...
        },
        {
          ...
          entregadescripcion: `Este documento especifica los siguientes factores relacionados con el diseño responsable:
      ...
      Roles: [
        {
          ...
          descripcion: `Consiste en el rol que hace parte del equipo de Arquitectos, responsable de llevar a cabo la realización de las actividades A8, A9 y A12, A18 y A19 necesarios para la generación de la propuesta de diseño de la experiencia multimedia, y las especificaciones del diseño responsable. `,
        ...
        },
        {
          ...
          descripcion: `Consiste en el rol que hace parte del equipo de Arquitectos, responsable de llevar a cabo la realización de la actividad A10, para la definición de los contenidos multimedia, su estructura y la concepción de las ambientaciones necesarias para su despliegue, como elementos clave de la propuesta de diseño de la experiencia multimedia.`,
          actividades: ["A10"],
          perfiles: [
            "Ing Multimedia",
            "Diseñador",
        ...
        },
        {
          ...
          descripcion:
            "Es el rol responsable porque se cumplan las actividades A12 y A17, necesarias para generar el producto de trabajo de la propuesta de diseño de la experiencia multimedia, y las especificaciones del diseño responsable.",
          actividades: ["A12", "A17"],
          perfiles: [
            "Ing Multimedia",
            "Gestor de software",
        ...
        },
        {
          ...
          descripcion: `Es el rol responsable de llevar a cabo la actividad A14, que consiste en planificar y realizar las diferentes pruebas que se estimen necesarias, para verificar la concepción del diseño de la experiencia multimedia, y sus diferentes elementos constitutivos, como parte fundamental de la propuesta de diseño de la experiencia multimedia interactiva.`,
          actividades: ["A14"],
          perfiles: [
            "Ing Multimedia",
            "Diseñador UX",
      ...
      Herramientas: [
        {
          ...
          descripcion: `Corresponde los diferentes bocetos que recrean los Storyboards que expresan la historia en la cual se inscribe la experiencia multimedia.`,
          bibliografia: ``,
        },
        {
          nombre: "Bosquejos de metáforas y analogías",
          descripcion: `Son los bosquejos producidos en torno a la representación de diferentes elementos pertenecientes al universo narrativo, y con asociación a otros elementos del mundo real, en el cual tiene lugar la historia en la que se inscribe la experiencia multimedia. `,
          bibliografia: ``,
        },
        {
          nombre: "Registro de vídeos",
          descripcion: `Se trata del registro de diferentes espacios de trabajo registrados digitalmente y con el permiso de sus participantes, en los diferentes espacios de ideación y creatividad del equipo de trabajo con los interesados.`,
          bibliografia: ``,
        },
        {
          nombre: "Matriz de medios digitales/PS/MI",
          descripcion: `Facilita la organización y asociación de los medios digitales, percepciones sensoriales y modalidades de interacción más indicadas, para el despliegue de la experiencia multimedia.`,
          bibliografia: ``,
        },
        {
          nombre: "Metada de personas",
          descripcion: `Ayuda a representar a las personas y a sus intereses en el contexto de la experiencia multimedia interactiva.`,
          bibliografia: ``,
        },
        {
          nombre: "Tarjetas de clasificación de información",
          descripcion: `Permite la clasificación de la información y su relación con los demás elementos que componen la experiencia multimedia interactiva. Sirve además para la realización del trabajo en etapas posteriores como la producción, para la definición de una arquitectura de información.`,
          bibliografia: ``,
        },
        {
          nombre: "Generación de prototipos físicos/digitales",
          descripcion: `Se trata de una representación mediante la cual se acuerda y se concreta la ideación y la creatividad, llevada a cabo bajo una mirada colectiva de los interesados, sobre los diferentes elementos que componen la experiencia multimedia interactiva, y que es útil a lo largo de todo el ciclo de vida del desarrollo de un Sistema Multimedia.`,
          bibliografia: ``,
        },
        {
          nombre: "Journey Map",
          descripcion: `Permite expresar la historia de la experiencia multimedia, los elementos que componen su universo narrativo, y el contenido multimedia, mediante una representación visual, en un orden cronológico y/o por eventos, que facilita su entendimiento y alcance, por parte de los interesados. `,
          bibliografia: ``,
        },
        {
          nombre: "Kit de tarjetas de previsión",
          descripcion: `Es un kit de tarjetas, para la realización de diferente tipo de análisis, en este caso, permite identificar tensiones de valor, posibles usos futuros del Sistema Multimedia, y usos diferentes para los cuales fue concebido.`,
          bibliografia: ``,
        },
        {
          nombre: "Reunión lluvia de ideas leyes y normatividades",
          descripcion: `Consiste en espacios de trabajo que facilitan el análisis, identificación y discusión sobre aspectos legales y normativos, que pueden influyen en la concepción de la experiencia multimedia, así como en el desarrollo del Sistema Multimedia.`,
          bibliografia: ``,
        },
        {
          nombre: "Matriz de patrones",
          descripcion: `Facilita la clasificación y documentación de los patrones identificados, que influyen en la concepción de la experiencia multimedia, y que pueden ser reutilizados para el desarrollo del Sistema Multimedia.`,
          bibliografia: ``,
        },
      ],
      Actividades: [
        {
          ...
          tecnica: 1,
          listecncias: [
            "Video como apoyo a la etnografía",
            "Definición de personas",
            "Producción de metáforas y analogías",
        ...
        },
        {
          ...
          listecncias: [
            "Producción de metáforas y analogías",
            "Generación de Storyboards",
            "Mapa de experiencias convincentes",
        ...
        },
        {
          ...
          listecncias: [
            ...
            "Base de datos de observaciones del usuario",
          ],
        },
      ],
      Tecnicas: [
        ...
        },
        {
          ...
          descripcion:
            "-Asegúrese de entender el contexto en donde se llevará cabo el despliegue de la experiencia multimedia. -Estudie el panorama e identifique patrones en el nivel de abstracción del contexto. -Identifique los patrones de “panorama” que establezcan el contexto. Para esto, aborde el problema en su mayor nivel de abstracción identificando patrones que respondan a su necesidad.  -Trabaje dentro del contexto con el fin de identificar patrones a un nivel más bajo de abstracción que ayuden posteriormente al diseño de la solución. Para esto, intente subdividir el problema, en problemas más concretos e intente identificar patrones en dicho nivel.",
          bibliografia: "",
        },
        {
          titulo: "Base de datos de observaciones del usuario",
          descripcion:
            "-Identifique la información que debe ser ingresada en la base de datos, desde las diferentes técnicas aplicadas. -Registre los datos con información relevante relacionada con su captura: nombre de quien captura la información, dato, locación, título de la observación, descripción y cualquier otra información considerada como relevante para el equipo de trabajo. -Etiquete los datos con marcos simples con significado útil para el equipo. -Realice búsquedas y comparte los hallazgos con proyectos de Sistemas Multimedia desarrollados con anterioridad e identifique patrones y nuevas perspectivas para el actual proyecto.",
          bibliografia: "",
        },
      ],
      contenidos: [
...

    {
      ...
      Roles: [
        {
          nombre: "Arquitecto Experiencia Multimedia",
          descripcion: `Consiste en el rol que hace parte del equipo de Arquitectos, responsable de llevar a cabo la realización de un conjunto de productos de trabajo de la práctica.`,
          actividades: ["A6"],
          perfiles: [
            "Ing Multimedia",
            "Desarrollador FullStack",
        ...
        },
        {
          ...
          descripcion: `Responsable de llevar a cabo, una serie de esfuerzos relacionados principalmente, con el análisis de viabilidad del Sistema Multimedia. `,
          actividades: ["A5", "A13"],
          perfiles: [
            "programador",
            "Desarrollado Backend",
            "Desarrollador FullStack",
            "Gestor de software",
            "Gestor de hardware",
          ],
        ...
        {
          nombre: "Arquitecto de información",
          descripcion: `Es el rol responsable dentro del análisis de viabilidad, de analizar a la luz de la información y estructura, que sustenta el contenido multimedia, realizar una concepción inicial acerca de las posibles motivaciones que tengan potenciales adversarios para atacar el sistema Multimedia, así como las consecuencias que esto podría traer a sus usuarios. `,
          actividades: ["A4"],
          perfiles: [
            "Ing Multimedia",
            "Gestor de software",
        ...
        },
        {
          ...
          descripcion: `Es un miembro del equipo de diseño, cuya participación como apoyo en el análisis para la proposición de valor, visión y modelo Canvas del Sistema Multimedia mínimo viable, resulta crucial, dada la relevancia que deben cumplir los medios audiovisuales en la creación de Valor del Sistema Multimedia mínimo viable.`,
          actividades: ["A20", "A21"],
          perfiles: [
            "Diseñador gráfico",
            "Animadores 2D",
            ...
            "Modelador 3D",
            "Diseñador de sonido",
            "Diseñador de fotografía",
            "Productor audiovisual",
          ],
        },
        {
          nombre: "Diseñador de Concepto y Storyboard",
          descripcion: `Se trata de un miembro del equipo de diseño, que apoya el análisis frente a la definición del Sistema Multimedia mínimo viable, atendiendo a su alineación frente al universo narrativo y la historia que han sido concebidas para la experiencia multimedia interactiva.`,
          actividades: ["A16", "A22"],
          perfiles: [
            "Diseñador de producto",
            "Ing Multimedia",
      ...
      Herramientas: [
        {
          ...
          descripcion: `Permite concretar la hipótesis de valor, identificando para quiénes se persigue generar la creación de valor como resultado del desarrollo del Sistema Multimedia, expresando el problema que desea resolverse, la necesidad que busca satisfacerse, y la experiencia que pretende ofrecerse.`,
          bibliografia: ``,
        },
        {
          nombre: "Matriz de clasificación de recursos",
          descripcion: `Por medio de la realización del análisis de estimación análoga y ascendente de recursos, se produce una matriz que estime los recursos necesarios y disponibles, para el desarrollo del Sistema Multimedia.`,
          bibliografia: ``,
        },
        {
          nombre: "Matriz DOFA",
          descripcion: `Se trata de una matriz la cual no solamente puede aportar a la práctica sobre conocer mejor las motivaciones y necesidades que tienen clientes y patrocinadores, sino también, a las limitaciones que se tienen para alcanzarlas, como parte del análisis de viabilidad en el desarrollo del Sistema Multimedia.`,
          bibliografia: ``,
        },
        {
          nombre: "Estructura de desglose de riesgos del SM ",
          descripcion: `A partir del análisis del desglose de riesgos, se lleva a cabo una estimación de los riesgos internos y externos, efectuando una jerarquía de riesgos asociados a la realización del Sistema Multimedia, relacionados con aspectos financieros, tecnológicos, políticos, normativos, entre otros.`,
          bibliografia: ``,
        },
        {
          nombre: "Kit tarjetas de previsión",
          descripcion: `Ofrece la posibilidad para que los interesados y el equipo de trabajo, realicen una actividad encaminada hacia el análisis de las posibles motivaciones que pueden tener interesados indirectos, en atacar el Sistema Multimedia, entre otros factores.`,
          bibliografia: ``,
        },
        {
          nombre: "Matriz de riesgos",
          descripcion: `Se produce a partir de la identificación de riesgos por parte del equipo de trabajo, valiéndose de la realización de entrevistas y posible encuestan en campo, a diferentes interesados relacionados con el Sistema Multimedia.`,
          bibliografia: ``,
        },
        {
          nombre: "Matriz para la clasificación de recursos Hardware/Software",
          descripcion: `Se trata de un instrumento que permite recopilar la información concebida, relacionada con los recursos específicos de hardware y software estimados para el desarrollo del Sistema Multimedia. `,
          bibliografia: ``,
        },
        {
          nombre: "Lluvia de ideas posibles métodos de ataque",
          descripcion: `Apertura de espacios de trabajo colaborativo entre interesados y equipo de trabajo, con el fin de analizar las motivaciones, así como los posibles métodos de ataque al Sistema Multimedia, por parte de interesados indirectos. `,
          bibliografia: ``,
        },
        {
          nombre: "Matriz de proposición de valor",
          descripcion: `Corresponde a la matriz que permite llevar a cabo, la realización del análisis de proposición de valor del Sistema Multimedia mínimo viable.  `,
          bibliografia: ``,
        },
        {
          nombre: "Estructura para la formulación de la visión del SMMV",
          descripcion: `Corresponde al modelo de estructura gramatical que se sugiere, para llevar a cabo la realización de la formulación de la visión del Sistema Multimedia mínimo viable .`,
          bibliografia: ``,
        },
        {
          nombre: "Modelo Canvas adaptado",
          descripcion: `Se trata de la estructura adaptada para la realización del modelo Canvas para el Sistema Multimedia mínimo viable y la descripción de sus diferentes componentes constitutivos . `,
          bibliografia: ``,
        },
      ],
      Actividades: [
        ...
        },
        {
          ...
          listecncias: [
            ...
            "Identificación ascendente de recursos",
          ],
        },
        {
          titulo: "A6",
    ...
    -Analice los resultados obtenidos, junto a los interesados y realice los ajustes acordados.`,
        ...
        },
        {
          ...
          descripcion: `Generación del modelo Canvas para el Sistema Multimedia Mínimo Viable.
                    -Realice un análisis en cada uno de los elementos anteriormente descritos, comenzando con los de la parte superior y luego hacia los de la parte inferior.
    -Para la realización del análisis, utilice el PDSM y la proposición de valor del Sistema Multimedia, a partir de los cuales se fundamenta el modelo Canvas para el SMMV.
      ...
      Tecnicas: [
        ...
        },
        {
          ...
          descripcion: `-Identifique los aportes de valor de la solución que se concibe, en el Plan para el Desarrollo del Sistema Multimedia.
                    -Identifique al menos, dos soluciones existentes similares a la solución que actualmente se concibe (no necesariamente deben ser sistemas multimedia), y que sean utilizadas en el sector objetivo.
                    -Construya una matriz de proposición de valor, en donde se especifique por columnas:
                    *La propuesta de valor de la solución, desde un análisis en tres escenarios: lo que el Sistema Multimedia debe tener, lo que el Sistema Multimedia debe ofrecer, las delicias ofrecidas por el Sistema Multimedia (Tenga en cuenta el PDSM).
                    *Las dos soluciones escogidas para análisis.
                    *La solución basada en el Sistema Multimedia que se concibe.
                    *Una descripción en función del análisis que desea realizarse.
                    -Una vez desarrollada la matriz, discuta los resultados con clientes, patrocinadores y potenciales usuarios, así como con su equipo de trabajo, contrastándolo con el PDSM.
                    -Realice los ajustes que los interesados acuerden como necesarios.`,
          bibliografia: ``,
        },
        {
          ...
          descripcion: `-A partir de la proposición de valor, genere un espacio para lluvia de ideas con los interesados.
                    -Escoja diferentes ideas y estructúrelas a partir de una serie de conectores y conceptos, asegurándose hacer explícita la diferenciación de valor en torno a la propuesta que se concibe, en contraste con las existentes.
                    -Analice los resultados obtenidos, junto a los interesados y realice los ajustes acordados.`,
          bibliografia: ``,
        },
        {
          ...
          descripcion: `-Genere una estructura tipo Canvas con los
                    ...
                    *En la parte superior ubique: Visón del SMMV, Experiencia multimedia, Interesados, Oportunidad, Valores Humanos, Problema y Riesgos.
                    *En la parte inferior ubique: contenido multimedia, percepciones sensoriales y modalidades de interacción.
                    -Realice un análisis en cada uno de los elementos anteriormente descritos,  comenzando con los de la parte superior y luego hacia los de la parte inferior.
                    -Para la realización del análisis, utilice el PDSM y la proposición de valor del Sistema Multimedia, a partir de los cuales se fundamenta el modelo Canvas para el SMMV.
                    -Evalúe el resultado del modelo Canvas para el SMMV y discútalo con los interesados.
                    -Realice los ajustes al modelo Canvas del SMMV en función de la retroalimentación de los interesados.`,
