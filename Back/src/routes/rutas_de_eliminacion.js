...
rutas.delete("/eliminar/proyecto", proToken, (req, res) => {
  ...
  deleteDB
    ...
    .then((result) => {
      ftpminio
        .removeBucket(`proyecto${proyecto}`, result.archivos)
        .then((result2) => {
...
rutas.delete("/delete/herramientas", (req, res) => {
  ...
  if (typeof id === "number") {
    deleteDB
      .deleteledeletetoolsnguaje(req.body)
      .then((re) => {
        res.json(re);
      })
      .catch((err) => res.json(err));
...
rutas.delete("/delete/herramientasmetodologia", (req, res) => {
  ...
  if (typeof id === "number") {
    deleteDB
      .deleteToolsMetodology(req.body)
      .then((re) => {
        res.json(re);
      })
      .catch((err) => res.json(err));
...
rutas.delete("/delete/listaerramientasmetogologia", (req, res) => {
  ...
  if (typeof id === "number") {
    deleteDB
      .deleteListToolsMetodology(req.body)
      .then((re) => {
        res.json(re);
      })
      .catch((err) => res.json(err));
                ...
                deleteDB
                  ...
                  .then((result) => {
                    deleteDB
                      ...
                      .then((result) => {
                        deleteDB
                          .deleteallListLenguaje()
                          .then((result) => {
                            deleteDB
                              .deleteallContact()
                              .then((result) => {
                                deleteDB
                                  .deleteallListContact()
                                  .then((result) => {
                                    deleteDB
                                      .deleteallListAbility()
                                      .then((result) => {
                                        deleteDB
                                          .deleteListTools()
                                          .then((result) => {
                                                                                                                        ...
                                                                                                                        deleteDB
                                                                                                                          ...
                                                                                                                          .then(
                                                                                                                            (
                                                                                                                              ...
                                                                                                                              deleteDB
                                                                                                                                .deleteallListDeliverable()
                                                                                                                                .then(
                                                                                                                                  (
                                                                                                                                    result
                                                                                                                                  ) => {
                                                                                                                                    deleteDB
                                                                                                                                      .deleteallListToolsMetodology()
                                                                                                                                      .then(
                                                                                                                                        (
                                                                                                                                          result
                                                                                                                                        ) => {
                                                                                                                                          deleteDB
                                                                                                                                            .deleteallListContect()
                                                                                                                                            .then(
                                                                                                                                              (
                                                                                                                                                result
                                                                                                                                              ) => {
                                                                                                                                                                              ...
                                                                                                                                                                              deleteDB
                                                                                                                                                                                ...
                                                                                                                                                                                .then(
                                                                                                                                                                                  (
                                                                                                                                                                                    ...
                                                                                                                                                                                    deleteDB
                                                                                                                                                                                      .deleteallListMeeting()
                                                                                                                                                                                      .then(
                                                                                                                                                                                        (
                                                                                                                                                                                          result
                                                                                                                                                                                        ) => {
                                                                                                                                                                                          deleteDB
                                                                                                                                                                                            .deleteallListDelivery()
                                                                                                                                                                                            .then(
                                                                                                                                                                                              (
                                                                                                                                                                                                result
                                                                                                                                                                                              ) => {
...
rutas.delete("/delete/bucket", (req, res) => {
  ...
  ftpminio
    .removeBucket(`proyecto${proyecto}`, archivos)
    .then((result2) => {
      res.json("Adios amigo");
    })
    .catch((err2) => res.json(err2));
