...
-- Volcando datos para la tabla proyectoweb.contactos: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla proyectoweb.habilidades: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla proyectoweb.herramientas: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla proyectoweb.idiomas: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla proyectoweb.personas: ~0 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `proyectos` (
  ...
  KEY `practica` (`practica`),
  CONSTRAINT `proyectos_ibfk_1` FOREIGN KEY (`integrante`) REFERENCES `integrantes` (`id`),
  CONSTRAINT `proyectos_ibfk_2` FOREIGN KEY (`historia`) REFERENCES `historial` (`id`),
  CONSTRAINT `proyectos_ibfk_3` FOREIGN KEY (`practica`) REFERENCES `practicas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- Volcando datos para la tabla proyectoweb.usuarios: ~0 rows (aproximadamente)
