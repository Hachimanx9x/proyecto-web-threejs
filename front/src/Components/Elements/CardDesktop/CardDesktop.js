...
const CardDesktop = ({update}) => {
    const project = <strong className=" ml-1 mr-1 cyan-text">{update.projectName}</strong>;
    return (
        <div className="bg-white o-desktop-card">
            ...
            <div className="mt-2 mb-2">
                ...
                Actividad <strong className=" ml-1 mr-1 cyan-text">{update.activity}</strong> del proyecto {project} fue realizada.
                </div>
            <div className="row">
                <div className="col-6 col-sm-3">
                    <p className="grey-text"><FontAwesomeIcon icon={faCalendarAlt} />{update.date}</p>
                </div>
                <div className="col-6 col-sm-3">
                    <p className="grey-text"><FontAwesomeIcon className="text-danger" style={{ borderColor: "red" }} icon={faClock} />{update.hour}</p>
                </div>
