            ...
            <div>
                ...
                <div className="o-blue-container o-blue-container-2"  >
                    <div className="o-talent-intro">
                        <div className="col-12 col-sm-4 justify-content-center align-items-center d-flex">
                            <div className="col-xs-6">
                                <img src={User} className="o-profile-talent-picture rounded-circle" alt="Foto de perfil del usuario" />
                            </div>
                    ...
                    <div className="bg-white rounded o-description-profile-contact mt-2 mb-2 p-1">
                        <p className="m-1">rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrraaaaaaaaaaaarrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr</p>
                    </div>
                    ...
                    <div className="o-talent-tool-list">
                        <div className="mt-2 mb-2 p-1 bg-white rounded row">
                            <div className="col-12 col-sm-1 text-center">
                                <img className="o-talent-tool" src="https://www.vectorlogo.zone/logos/typescriptlang/typescriptlang-icon.svg" alt="User tool" />
                            </div>
                            <div className="col-12 col-sm-9 o-tool-description text-justify">
                                <p>TypeScript is the typed version of javascript. This variant of the javascript frontend language aims to solve many of the problems such as non typed issues of data. It's commonly used in Angular.js but it can be used in other frameworks such as React.js and Svelte.js. This is one of the top 10 more used and demmanded languages around the world currently.</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-white p-2 rounded">
                        <MDBInput className="ml-0 mr-0" style={{ maxWidth: "40rem" }} label="Asunto" outline />
                        <MDBInput type="textarea" className="m-0 mr-0 rounded" label="Cuerpo" outline />
                    </div>
                </div>
            </div>
        );
