...
class Test3d extends Component {
  ...
  componentDidMount() {
    ...
    objectI1.scale.set(0.2, 0.2, 0.2);
    objectI1.position.set(0.2, 0.33, 0);
    var objectI2 = new THREE.Mesh(
      geocaja,
      new THREE.MeshBasicMaterial({ color: 0xf2380e })
    );
    objectI2.scale.set(0.2, 0.2, 0.2);
    objectI2.position.set(-0.2, 0.33, 0);

    this.scene.add(objectI1);
    this.scene.add(objectI2);
