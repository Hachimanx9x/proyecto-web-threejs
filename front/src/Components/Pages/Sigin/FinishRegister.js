...
export default function FinishRegister() {
    ...
    const tools = [
        ...
        { cat: { id: "5", icon: "https://www.vectorlogo.zone/logos/python/python-icon.svg", name: "Python" }, key: 'Python' },
        ...
        <div className="o-register-container">
                ...
                <div className="col-xs-12 col-sm-3 o-col mb-4 pb-5">
                    ...
                    <Multiselect
                        ...
                        onSelect={(selectedList, selectedItem) => {
                            ...
                            const item = lang.find(iterador => iterador === selectedItem.cat);
                            if (!item) {
                    ...
                    <Multiselect
                        ...
                        onSelect={(selectedList, selectedItem) => {
                            ...
                            const item = keyword.find(iterador => iterador === selectedItem.cat);
                            if (!item) {
            ...
            <div className="bg-white rounded mt-3 row text-center p-2" style={{ height: "auto" }}>
                ...
                <div className="col-xs-12 col-sm-8">
                    <p>Descripción</p>
                    <MDBInput type="textarea" label="Descripción" className="rounded" onChange={e => { setDescription(e.target.value); }} outline />
                </div>
                    ...
                    <div className="rounded p-2 pt-3 d-flex o-skill-list-cnt">
                        {skills.map((skill) => (
                            <div key={skill.id} className="o-card-select-skill rounded">
                                ...
                                <img className="o-selected-skill-img bg-white" alt={skill.name} src={skill.icon} />
