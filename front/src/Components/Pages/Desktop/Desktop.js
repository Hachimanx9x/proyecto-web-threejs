...
class Desktop extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            color : '#80BD01',
            bgcolor : '#CFEC92',
            datagraph :[65, 59, 90, 81, 56, 55, 40],
            updates: [
            ...
            <div className="row mb-5 pb-5" >
                ...
                <div className="col-12 col-sm-3 ml-1 o-blue-container o-slider-container" >
                    ...
                    <div className="bg-white rounded p-1 mb-2 mt-2 text-center">
                        <Radar data={data}  />
                        <button onClick={() => { this.setState({ bgcolor: "#CFEC92", color: "#80BD01", datagraph: [65, 59, 90, 81, 56, 55, 40] }) }} className="o-btn-graph rounded text-success border-success font-weight-bold mt-4 z-depth-0">Sistema multimedia mínimo viable</button>
                        <button onClick={() => { this.setState({ bgcolor : "#eaea91", color : "#bc8a01", datagraph : [75, 99, 40, 41, 76, 25, 45] })}} className="o-btn-graph bg-warning rounded text-white border-0 font-weight-bold mt-2 z-depth-0">Concebir la experiencia multimedia</button>
                    </div>
