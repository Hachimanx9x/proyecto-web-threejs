...
class Contacts extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            keyWord: "", modal: false, filter: "", contacts: [{
                id: "some crap",
    ...
    render() {
        ...
        const initialSelectedIndex = options.findIndex(({ value }) => value === "Preferidos");
                    ...
                    <div className="col-12 col-sm-8 ">
                        <div className="o-bg-blue row">
                            <div className="col-12 col-sm-6">
                                <p className="align-text-c enter mb-2" style={{ fontSize: "0.8rem" }}>Profesión</p>
                                <div className="input-group mb-3">
                                    <input type="text" className="form-control m-0 o-rounded-input" placeholder="Palabra clave" aria-label="Palabra clave" />
                                    <div className="input-group-append">
                                        <button className="btn btn-primary text-white m-0 z-depth-0 o-keyword-btn" type="button"><FontAwesomeIcon icon={faSearch} /></button>
                                    </div>
                                </div>
                            </div>
                            <div className="col-12 col-sm-6">
                                <p className="mb-2" style={{ fontSize: "0.8rem" }}>Destacados</p>
