...
class CreateProject extends Component {
    ...
    */
    ...
    render() {
        return (
            <div className="row" >
                <Rodal width={this.state.windowWidth < 600 ? 400 : 1000} height={350} animation={"fade"} visible={this.state.modal} onClose={() => this.setState({ modal: false })}>
                ...
                <div className="col-xs-12 col-sm-8 o-project-creation-section">
                    ...
                    <div className="row bg-white mt-4 flex-column" style={{ borderRadius: "1rem" }}>
                        <div className="d-flex justify-content-between">
                            ...
                            <button onClick={this.showContacts} className="z-depth-0 border-0 btn btn-primary font-weight-bold m-3">Agregar</button>
                        </div>
                        <div className="o-member-selection-container">
                            {this.state.members.length === 0 ?
                                <p className="text-secondary m-auto">No hay miembros seleccionados</p> :
                                this.state.members.map((member, i) => (
                                    <CardMember remove={this.removeMember} change={this.changeRol} key={i} member={member} />
                                ))
                            }
                        </div>
                    </div>
                ...
                <div className="col-xs-12 col-sm-4 o-blue-container o-practice-container">
                    ...
                    <div className="bg-white rounded mb-2 p-2">
                        ...
                        <div className="d-flex justify-content-between">
                            ...
                            <a href="Documentation" className="o-btn-partices rounded btn-warning text-white z-depth-0">Mas información</a>
                        </div>
                    </div>
                    <div className="bg-white rounded p-2">
                        ...
                        <div className="d-flex justify-content-between">
                            <input type="checkbox" className="bg-warning mt-2 rounded border-warning" />
                            <a href="Documentation" className="o-btn-partices rounded bg-success text-white z-depth-0">Mas información</a>
                        </div>
                    </div>
                </div>
            </div>
